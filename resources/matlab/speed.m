	...
	function [] = speed(source, fps, step, maxTime, bodies)
		...
		plot(time ./ secondsByDay, S(:, 1));

		display.CurrentAxes.Title.String = ['Voyager-1: Speed (\Deltat = ', num2str(step/fps), ' [s])'];
		display.CurrentAxes.Title.FontSize = 16;
		display.CurrentAxes.Title.FontWeight = 'bold';
		display.CurrentAxes.Title.Color = [0, 0, 0];
		display.CurrentAxes.XLabel.String = 'Tiempo [dias]';
		...
		display.CurrentAxes.YLabel.String = 'Modulo de la Velocidad [km/s]';
	end
